 ...
 useEffect(() => {
    const requestTopRatedMovies = async () => {
      const getTopRatedMovies = await axios.get(
        "https://api.themoviedb.org/3/movie/top_rated?api_key=b0380404025ff71ff7222783b12710df"
      );
  ...
  useEffect(() => {
    const requestUpcomingMovies = async () => {
      const getUpcomingMovies = await axios.get(
        "https://api.themoviedb.org/3/movie/upcoming?api_key=b0380404025ff71ff7222783b12710df"
      );
  ...
  useEffect(() => {
    const requestOnlineStreamMoviesMovies = async () => {
      const getOnlineStreamMovies = await axios.get(
        "https://api.themoviedb.org/3/movie/popular?api_key=b0380404025ff71ff7222783b12710df"
      );
